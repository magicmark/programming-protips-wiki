...
1) The code is buggy, or the typechecker/linter itself is buggy. If this is the case, see if someone else has already reported this issue (if not, file a ticket).
